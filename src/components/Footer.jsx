...
const Footer = () => {
  return (
    <footer id='about' className='bg-white py-16'>
        ...
        <div className='grid grid-cols-1 md:grid-cols-4 gap-8'>
          ...
          <div className='space-y-4'>
            ...
            <ul className='space-y-2'>
              ...
              <li>
                <a href='#about' className='text-gray-600 hover:text-[#73a334]'>
                  Kontakt
                </a>
              </li>
            </ul>
          ...
          <div className='space-y-4'>
            ...
            <ul className='space-y-2 text-gray-600'>
              <li className='flex items-center gap-2'>
                <Mail className='w-5 h-5 text-[#8ac240]' />
                <a
                  href='mailto:info@ime-reisen.de'
                  className='font-bold hover:text-[#8ac240] transition-colors'
                >
                  info@ime-reisen.de
                </a>
              </li>
              <li className='flex items-center gap-2'>
                <svg viewBox='0 0 24 24' className='w-5 h-5 fill-[#73a334]'>
                ...
                <a
                  href='https://wa.me/4915753357895'
                  target='_blank'
              ...
              <li className='flex items-center gap-2'>
                ...
                <a
                  href='https://www.instagram.com/ime_reisen_official/'
                  target='_blank'
                  rel='noopener noreferrer'
                  className='font-bold hover:text-[#8ac240] transition-colors'
                >
